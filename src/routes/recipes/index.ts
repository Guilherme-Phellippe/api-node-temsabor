...
app.get('/recipes', async (req: any, res: any) => {
    ...
    const recipes = await prisma.recipe.findMany({
        select: {
            ...
            ing: true,
            stuffing_ing: true,
            type_stuffing_ing: true,
            products_used_recipe: true,
            word_key: true,
            prepareMode: true,
            nmr_hearts: true,
            nmr_eyes: true,
...
app.post('/recipe', async (req: any, res: any) => {
    ...
    const recipe = await prisma.recipe.create({
        data: {
            ...
            type_stuffing_ing: recipeInfo.type_stuffing_ing,
            word_key: recipeInfo.word_key,
            prepareMode: recipeInfo.prepareMode,
            type_prepare_mode: recipeInfo.type_prepare_mode,
